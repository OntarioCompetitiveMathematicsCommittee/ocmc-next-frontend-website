...
const Navbar = () => {
	...
	return (
		<>
			<nav
				className='flex justify-center w-full bg-brandNeutral-200 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-60 
                py-2 px-4 fixed top-0 left-0 z-50 shadow-sm'>
				<div className='max-w-[90rem] w-full flex justify-between items-center'>
					<Link
						className='flex items-center text-2xl font-medium gap-2'
						href='/'>
						<Image
							className='h-12 w-12'
							src={Logo}
					...
					<div className='flex items-center'>
						<ul
							...
							<Link
								className='rounded-md cursor-pointer border-2 box-border px-6 py-1 transition-all group 
								...
								href='/signup'>
								<div
									className='font-medium text-transparent bg-clip-text bg-gradient-to-r from-brandBlue-500 
