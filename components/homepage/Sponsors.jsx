...
const Sponsors = () => {
    return (
        <section className=' bg-brandNeutral-100 py-6 relative overflow-hidden whitespace-nowrap'>
            <div className="animate-scroll inline-block w-auto bg-brandNeutral-100">
